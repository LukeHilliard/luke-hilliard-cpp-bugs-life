 ...
 *
 *      Making the Bugs move is one of the main reasons I created the rebuild repo and started rebuilding my project, I want to try and find the root cause of some of my issues from developing on the shared repo
 */
